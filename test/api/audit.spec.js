...
test.describe('Audit/Inventory Logs API Tests', () => {
  ...
  test('A2 - GET /api/audit-logs - Search by keyword', async ({ request }) => {
  ...
  test('A3 - GET /api/audit-logs - Filter by action', async ({ request }) => {
  ...
  test('A4 - GET /api/audit-logs - Filter by date range', async ({ request }) => {
  ...
  test('A6 - GET /api/audit-logs/entity/{type}/{id} - Get logs by entity with valid ID', async ({ request }) => {
    // First get some logs to find a valid entity
  ...
  test('A9 - GET /api/inventory/transactions - Filter by transaction type', async ({ request }) => {
  ...
  test('A10 - GET /api/inventory/transactions - Filter by warehouse', async ({ request }) => {
  ...
  test('A11 - GET /api/inventory/transactions - Search by SKU', async ({ request }) => {
  ...
  test('A12 - GET /api/inventory/transactions - Filter by date range', async ({ request }) => {
    const from = new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString();
    const to = new Date().toISOString();
  ...
  test('A15 - GET /api/audit-logs - Invalid date format returns 400', async ({ request }) => {
