              ...
              <table className={styles.table}>
                <thead>
                  <tr>
                    ...
                    <th className={`${styles.th} ${styles.thRight}`} title="Hàng đang được giữ cho đơn hàng nhưng chưa đưa vào phiếu xuất">Giữ hàng</th>
                    <th className={`${styles.th} ${styles.thRight}`} title="Số lượng có thể bán = Trong kho - Giữ hàng - Đang xuất">Có thể bán</th>
