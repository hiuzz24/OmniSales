...
export const IMPORT_TEMPLATE_COLUMNS = [
  { key: 'productSku',   label: 'Mã sản phẩm (SKU cha)', required: true,  example: 'SP-001' },
  ...
  { key: 'description',  label: 'Mô tả',                required: false, example: 'Áo thun cotton 100%, co giãn 4 chiều' },
  { key: 'unit',         label: 'Đơn vị',               required: false, example: 'cái' },
  { key: 'status',       label: 'Trạng thái',           required: false, example: 'DRAFT / ACTIVE / INACTIVE' },
  ...
  { key: 'price',        label: 'Giá bán',              required: true,  example: '150000' },
  { key: 'costPrice',    label: 'Giá vốn',              required: false, example: '80000' },
...
export const IMPORT_TEMPLATE_EXAMPLES = [
  {
    label: 'Sản phẩm A (1 biến thể duy nhất)',
    rows: [
      {
        productSku: 'SP-001',
  ...
  {
    label: 'Sản phẩm B (3 biến thể màu + size)',
    rows: [
      {
        productSku: 'SP-002',
      ...
      },
      {
        ...
        unit: 'cái',
        status: 'ACTIVE',
        variantSku: 'SP-002-BLUE-L',
        variantName: 'Xanh dương / L',
        price: '250000',
        costPrice: '120000',
        barcode: '8934673002003',
        weightGrams: '320',
      },
    ],
  },
  {
    label: 'Sản phẩm C (2 biến thể chỉ khác tên)',
    rows: [
      {
        productSku: 'SP-003',
        productName: 'Mũ lưỡi trai thêu logo',
        categoryName: 'Phụ kiện',
        brand: 'OEM',
        description: '',
        unit: 'cái',
        status: 'INACTIVE',
        variantSku: 'SP-003-BLACK',
        variantName: 'Đen',
        price: '90000',
        costPrice: '40000',
        barcode: '',
...
const HEADER_NORMALIZE = {
  'mã sản phẩm (sku cha)': 'productSku',
...
const REQUIRED_KEYS = ['productSku', 'productName', 'variantSku', 'price'];
