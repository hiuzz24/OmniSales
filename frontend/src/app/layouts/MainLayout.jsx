...
const NAV_ITEMS = [
  ...
  { name: 'Sản phẩm',       href: '/products',       icon: Package,         roles: [] },
  {
    ...
    children: [
      ...
      { name: 'Phiếu nhập kho',   href: ROUTES.WAREHOUSE_RECEIPTS,     icon: PackagePlus    },
...
export default function MainLayout() {
  ...
  const [expanded, setExpanded] = useState([]); // tất cả đóng mặc định
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f8fafc' }}>
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <button
            onClick={() => setOpen((v) => !v)}
            style={{ padding: 6, borderRadius: 8, border: 'none', background: 'none', cursor: 'pointer', color: '#64748b', display: 'flex', alignItems: 'center' }}
            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#f1f5f9'}
            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}
          >
            <Menu size={20} />
              ...
              <div key={item.name} style={{ marginBottom: 2 }}>
                {hasChildren ? (
                  <button
                    ...
                    onMouseLeave={(e) => { if (!parentActive) e.currentTarget.style.backgroundColor = parentActive ? '#eff6ff' : 'transparent'; }}
                  >
                    ...
                    {item.children.map((child) => {
                      ...
                      return (
                        <NavLink
                          ...
                          onMouseLeave={(e) => { if (!active) e.currentTarget.style.backgroundColor = active ? '#eff6ff' : 'transparent'; }}
                        >
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div ref={notifRef} style={{ position: 'relative' }}>
              ...
              {notifOpen && (
                <div style={{
                  position: 'absolute', right: 0, top: 44, width: 384,
                    ...
                    {NOTIFS.map((n) => {
                      ...
                      return (
                        <div key={n.id}
                          ...
                          style={{ display: 'flex', gap: 12, padding: '14px 20px', cursor: 'pointer', backgroundColor: isUnread ? 'rgba(239,246,255,0.5)' : 'transparent', borderBottom: '1px solid #f1f5f9' }}
                        ...
                        >
                          ...
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <p style={{ fontSize: 10, color: '#cbd5e1', margin: '4px 0 0' }}>{n.time}</p>
                          </div>
                        </div>
                      );
                    })}
