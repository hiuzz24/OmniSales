...
public class ShopifyReturnGraphQlClientImpl implements ShopifyReturnGraphQlClient {
    ...
    @Override
    public Map<String, Object> decline(UUID channelId, String returnGid, String reason) {
        Map<String, Object> input = new LinkedHashMap<>();
        input.put("id", returnGid);
        if (reason != null && !reason.isBlank()) input.put("declineReason", reason);
        String mutation = """
    ...
    public Map<String, Object> process(UUID channelId, String returnGid, ReturnActionContext context) {
        List<Map<String, Object>> lines = context.items().stream()
