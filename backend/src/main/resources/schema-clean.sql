...
-- â”€â”€â”€ 1. DROP TRIGGERS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€â”€ 2. DROP FUNCTIONS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€â”€ 3. DROP TABLES (children â†’ parents) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€â”€ 4. DROP ENUM TYPES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Users & Auth â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
CREATE TABLE users (
...
-- â”€â”€ Catalogue â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Suppliers & Warehouses â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Webhooks & Sync â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Order Returns & Items â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
-- â”€â”€ Logging & Reporting â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
INSERT INTO users (id, email, password_hash, full_name, phone, status) VALUES
                                                                           ...
                                                                           ('b0b1c2d3-0000-0000-0000-000000000002', 'manager@osms.vn', crypt('11111111', gen_salt('bf', 10)), 'Quáº£n lÃ½',   '0901000002', 'ACTIVE'),
                                                                           ('b0b1c2d3-0000-0000-0000-000000000003', 'staff@osms.vn',   crypt('11111111', gen_salt('bf', 10)), 'NhÃ¢n viÃªn', '0901000003', 'ACTIVE'),
                                                                           ('b0b1c2d3-0000-0000-0000-000000000004', 'viewer@osms.vn',  crypt('11111111', gen_salt('bf', 10)), 'Chá»‰ xem',   '0901000004', 'ACTIVE')
ON CONFLICT DO NOTHING;
...
INSERT INTO categories (id, parent_id, name, slug, sort_order) VALUES
                                                                   ('e0b1c2d3-0000-0000-0000-000000000001', NULL,                                   'Thá»i trang', 'thoi-trang', 1),
                                                                   ('e0b1c2d3-0000-0000-0000-000000000002', NULL,                                   'Äiá»‡n tá»­',    'dien-tu',    2),
                                                                   ('e0b1c2d3-0000-0000-0000-000000000003', 'e0b1c2d3-0000-0000-0000-000000000001', 'Ão',         'ao',         1)
ON CONFLICT DO NOTHING;

-- Products
INSERT INTO products (id, category_id, sku, name, description, brand, status, weight_grams, created_by, updated_by) VALUES
                                                                                                                        ('f0b1c2d3-0000-0000-0000-000000000001', 'e0b1c2d3-0000-0000-0000-000000000003', 'AO-001', 'Ão thun nam',       'Ão thun cotton 100%', 'MyBrand',  'ACTIVE', 200, 'b0b1c2d3-0000-0000-0000-000000000001', 'b0b1c2d3-0000-0000-0000-000000000001'),
                                                                                                                        ('f0b1c2d3-0000-0000-0000-000000000002', 'e0b1c2d3-0000-0000-0000-000000000002', 'PK-001', 'Tai nghe Bluetooth','Tai nghe chá»‘ng á»“n',   'AudioMax', 'ACTIVE', 150, 'b0b1c2d3-0000-0000-0000-000000000001', 'b0b1c2d3-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;
...
INSERT INTO product_variants (id, product_id, sku, name, barcode, price, cost_price, option_values, weight_grams, created_by, updated_by) VALUES
                                                                                                                                              ('10b1c2d3-0000-0000-0000-000000000001', 'f0b1c2d3-0000-0000-0000-000000000001', 'AO-001-TR-M',   'Ão thun Tráº¯ng M',  '8935001801234', 150000, 80000,  '{"color":"Tráº¯ng","size":"M"}',           200, 'b0b1c2d3-0000-0000-0000-000000000001', 'b0b1c2d3-0000-0000-0000-000000000001'),
                                                                                                                                              ('10b1c2d3-0000-0000-0000-000000000002', 'f0b1c2d3-0000-0000-0000-000000000001', 'AO-001-DE-L',   'Ão thun Äen L',    '8935001801235', 150000, 80000,  '{"color":"Äen","size":"L"}',             200, 'b0b1c2d3-0000-0000-0000-000000000001', 'b0b1c2d3-0000-0000-0000-000000000001'),
                                                                                                                                              ('10b1c2d3-0000-0000-0000-000000000003', 'f0b1c2d3-0000-0000-0000-000000000002', 'PK-001-PRO-DEN','Tai nghe Pro Äen', '8935001801236', 500000, 300000, '{"color":"Äen","version":"Pro"}',        150, 'b0b1c2d3-0000-0000-0000-000000000001', 'b0b1c2d3-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;
...
INSERT INTO customers (id, full_name, code, phone, email, address) VALUES
                                                                       ('70b1c2d3-0000-0000-0000-000000000001', 'Nguyá»…n VÄƒn A', 'KH-001', '0905111222', 'vana@gmail.com', '{"city":"TP.HCM","address":"789 LÃ½ ThÆ°á»ng Kiá»‡t"}'),
                                                                       ('70b1c2d3-0000-0000-0000-000000000002', 'Tráº§n Thá»‹ B',   'KH-002', '0905222333', NULL,             '{"city":"HÃ  Ná»™i","address":"456 Nguyá»…n ÄÃ¬nh Chiá»ƒu"}')
ON CONFLICT DO NOTHING;
...
INSERT INTO orders (id, channel_id, customer_id, platform, channel_name, external_order_id, status, payment_status, buyer_name, buyer_phone, shipping_address, subtotal, discount_amount, shipping_fee, currency, note, tracking_number) VALUES
                                                                                                                                                                                                                                             ('90b1c2d3-0000-0000-0000-000000000001', '30b1c2d3-0000-0000-0000-000000000001', '70b1c2d3-0000-0000-0000-000000000001', 'SHOPEE', 'Shopee Official', 'SHOPEE-ORDER-001', 'CONFIRMED', 'PAID',   'Nguyá»…n VÄƒn A', '0905111222', '{"address":"789 LÃ½ ThÆ°á»ng Kiá»‡t, Q.10","city":"TP.HCM"}', 300000, 0,     20000, 'VND', 'Giao hÃ ng nhanh', 'TN12345'),
                                                                                                                                                                                                                                             ('90b1c2d3-0000-0000-0000-000000000002', '30b1c2d3-0000-0000-0000-000000000002', '70b1c2d3-0000-0000-0000-000000000002', 'LAZADA', 'Lazada Mall',     'LAZADA-ORDER-002', 'PENDING',   'UNPAID', 'Tráº§n Thá»‹ B',   '0905222333', '{"address":"456 Nguyá»…n ÄÃ¬nh Chiá»ƒu","city":"HÃ  Ná»™i"}',   500000, 50000, 0,     'VND', '',                NULL)
ON CONFLICT DO NOTHING;

-- Order items
INSERT INTO order_items (id, order_id, variant_id, sku, name, quantity, unit_price, discount_amount, cost_price) VALUES
                                                                                                                     ('a0b1c2d3-0000-0000-0000-000000000001', '90b1c2d3-0000-0000-0000-000000000001', '10b1c2d3-0000-0000-0000-000000000001', 'AO-001-TR-M',   'Ão thun Tráº¯ng M',  2, 150000, 0, 80000),
                                                                                                                     ('a0b1c2d3-0000-0000-0000-000000000002', '90b1c2d3-0000-0000-0000-000000000001', '10b1c2d3-0000-0000-0000-000000000002', 'AO-001-DE-L',   'Ão thun Äen L',    1, 150000, 0, 80000),
                                                                                                                     ('a0b1c2d3-0000-0000-0000-000000000003', '90b1c2d3-0000-0000-0000-000000000002', '10b1c2d3-0000-0000-0000-000000000003', 'PK-001-PRO-DEN','Tai nghe Pro Äen', 1, 500000, 50000, 300000)
ON CONFLICT DO NOTHING;

-- Suppliers
INSERT INTO suppliers (id, name, contact_name, phone, email, address, is_active) VALUES
                                                                                     ('b0b1c2d3-0001-0000-0000-000000000001', 'CÃ´ng ty Dá»‡t May ABC', 'Nguyá»…n VÄƒn A', '0901234567', 'abc@maymac.com', '12 Nguyá»…n TrÃ£i, Q.5, TP.HCM',    TRUE),
                                                                                     ('b0b1c2d3-0001-0000-0000-000000000002', 'Äiá»‡n tá»­ XYZ',         'Tráº§n Thá»‹ B',   '0909876543', 'xyz@dientu.com', '34 Hai BÃ  TrÆ°ng, Q.1, TP.HCM',   TRUE)
ON CONFLICT DO NOTHING;

-- Warehouses
INSERT INTO warehouses (id, name, address, is_active) VALUES
                                                          ('c0b1c2d3-0000-0000-0000-000000000001', 'Kho chÃ­nh', '123 Nguyá»…n Huá»‡, Q.1, TP.HCM', TRUE),
                                                          ('c0b1c2d3-0000-0000-0000-000000000002', 'Kho phá»¥',   '456 LÃª Lá»£i, Q.3, TP.HCM',     TRUE)
ON CONFLICT DO NOTHING;
...
INSERT INTO notifications (id, user_id, type, title, body, entity_type, entity_id) VALUES
    ('c0b1c2d3-0002-0000-0000-000000000001', 'b0b1c2d3-0000-0000-0000-000000000002', 'LOW_STOCK', 'Sáº¯p háº¿t hÃ ng', 'Ão thun Äen L chá»‰ cÃ²n 80 sáº£n pháº©m', 'PRODUCT', 'f0b1c2d3-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;

-- Audit logs
INSERT INTO audit_logs (id, actor_id, actor_email, action, entity_type, entity_id, entity_name, performed_at, changes) VALUES
    ('d0b1c2d3-0002-0000-0000-000000000001', 'b0b1c2d3-0000-0000-0000-000000000001', 'admin@osms.vn', 'CREATE', 'PRODUCT', 'f0b1c2d3-0000-0000-0000-000000000001', 'Ão thun nam', NOW(), '{"action":"created"}')
ON CONFLICT DO NOTHING;
...
INSERT INTO report_configs (id, name, report_type, parameters, query_def, columns, schedule, is_active, created_by) VALUES
    ('f0b1c2d3-0002-0000-0000-000000000001', 'BÃ¡o cÃ¡o doanh sá»‘ thÃ¡ng', 'SALES', '{"period":"monthly"}', '{"sql":"SELECT * FROM daily_sales_summary"}', '["date","revenue"]', '0 0 1 * *', TRUE, 'b0b1c2d3-0000-0000-0000-000000000001')
ON CONFLICT DO NOTHING;
...
INSERT INTO product_logs (id, product_id, sku, action, field_changes, performed_by, performed_by_email, performed_at) VALUES
    ('20b1c2d3-0002-0000-0000-000000000001', 'f0b1c2d3-0000-0000-0000-000000000001', 'AO-001', 'CREATE', '{"name":"Ão thun nam"}', 'b0b1c2d3-0000-0000-0000-000000000001', 'admin@osms.vn', NOW())
ON CONFLICT DO NOTHING;
-- ============================================================
--  END OF SCRIPT
-- ============================================================
...
-- 1. ThÃªm cá»™t warehouse_id vÃ o báº£ng users kÃ¨m theo khÃ³a ngoáº¡i liÃªn káº¿t tá»›i báº£ng warehouses
ALTER TABLE users
    ADD COLUMN warehouse_id UUID REFERENCES warehouses(id) ON DELETE SET NULL;

-- 2. Táº¡o hÃ m (Trigger Function) Ä‘á»ƒ kiá»ƒm tra rÃ ng buá»™c role khi gÃ¡n kho
