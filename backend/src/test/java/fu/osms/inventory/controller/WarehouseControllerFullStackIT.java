...
class WarehouseControllerFullStackIT extends BaseFullStackIT {
    ...
    @Test
    @DisplayName("W3 — POST /api/warehouses not implemented — 405/500")
    ...
    @Test
    @DisplayName("W4 — PUT /api/warehouses/{id} not implemented — 500")
    ...
    @Test
    @DisplayName("W5 — DELETE /api/warehouses/{id} not implemented — 500")
