...
CREATE TYPE inv_txn_type AS ENUM ('IMPORT', 'EXPORT', 'ADJUSTMENT', 'ORDER_DEDUCT', 'ORDER_CANCEL');
...
INSERT INTO customers (id, full_name, phone, email, address) VALUES
                                                                 ('70b1c2d3-0000-0000-0000-000000000001', 'Nguyễn Văn A', '0905111222', 'vana@gmail.com', '{"city":"TP.HCM","address":"789 Lý Thường Kiệt"}'),
                                                                 ('70b1c2d3-0000-0000-0000-000000000002', 'Trần Thị B', '0905222333', NULL, '{"city":"Hà Nội","address":"456 Nguyễn Đình Chiểu"}');
...
INSERT INTO inventory_issues (id, warehouse_id, issue_code, issue_type, status, reference_id, total_cost, created_by, confirmed_at) VALUES
    ('20b1c2d3-0001-0000-0000-000000000001', 'c0b1c2d3-0000-0000-0000-000000000001', 'ISS-001', 'ORDER', 'CONFIRMED', '90b1c2d3-0000-0000-0000-000000000001', 160000, 'b0b1c2d3-0000-0000-0000-000000000001', NOW() - INTERVAL '1 day');
